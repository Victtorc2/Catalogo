...
export function Footer() {
  ...
  return (
    <footer className="mt-16 bg-ocean text-white">
      {/* Franja de confianza */}
          ...
          {[
            ...
            <div key={f.title} className="flex flex-col items-center gap-2 text-center sm:flex-row sm:text-left">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/10">
                <f.icon size={20} className="text-coral" />
              </div>
              <div>
      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="mt-4 flex items-center gap-2">
              {FACEBOOK_URL && (
                <a
                  ...
                  aria-label="Facebook"
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-[#1877f2]"
                >
              ...
              {TIKTOK_URL && (
                <a
                  ...
                  aria-label="TikTok"
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-black"
                >
        ...
        {/* Contacto */}
        <div>
          <h3 className="mb-3 font-display text-sm font-bold uppercase tracking-wider text-coral">
            Contacto
          </h3>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2.5 text-sm text-white/80">
            <li className="flex items-center gap-2">
              <Smartphone size={16} className="text-coral" /> Yape / Plin
            </li>
            <li className="flex items-center gap-2">
              <Banknote size={16} className="text-coral" /> Efectivo (recojo en tienda)
            </li>
            <li className="flex items-center gap-2">
              <CreditCard size={16} className="text-coral" /> Transferencia bancaria
            </li>
            <li className="flex items-center gap-2">
              <Truck size={16} className="text-coral" /> Contra entrega (según zona)
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 px-4 py-5 text-center text-xs text-white/50 sm:flex-row sm:text-left">
